...
ggplot(data, aes(x = NDTI, y = depth_sd)) +
  ...
  geom_abline(slope = -0.9405, intercept = 0.2220, 
              linetype = 'dashed', color = '#264653')
r <- cor(data$NDTI, data$depth_sd)

rmse <- sqrt(mean(mod$residuals^2))

print(paste0("r = ", r, ", RMSE = ", rmse))
...
ggplot(data, aes(x = NDTI, y = depth_sd)) +
  ...
  geom_abline(slope = -0.7332, intercept = 0.1721, 
              linetype = 'dashed', color = '#264653')
cor(data$NDTI, data$depth_sd)
r <- cor(data$NDTI, data$depth_sd)
...
ggplot(data, aes(x = NDTI, y = depth_sd)) +
  ...
  theme_classic() +
  labs(y = "Depth Stdev") +
  geom_abline(slope = 0.032875, intercept = 0.127101, 
              linetype = 'dashed', color = '#264653')
cor(data$NDTI, data$depth_sd)
r <- cor(data$NDTI, data$depth_sd)
rmse <- sqrt(mean(mod$residuals^2))
...
ggplot(data, aes(x = NDTI, y = depth_sd)) +
  ...
  theme_classic() +
  labs(y = "Depth Stdev") +
  geom_abline(slope = -0.061179, intercept = 0.166042, 
              linetype = 'dashed', color = '#264653')
cor(data$NDTI, data$depth_sd)
r <- cor(data$NDTI, data$depth_sd)
rmse <- sqrt(mean(mod$residuals^2))
...
ggplot(data, aes(x = NDTI, y = depth_sd)) +
  ...
  theme_classic() +
  labs(y = "Depth Stdev") +
  geom_abline(slope = 0.08245, intercept = 0.19238, 
              linetype = 'dashed', color = '#264653')
cor(data$NDTI, data$depth_sd)
r <- cor(data$NDTI, data$depth_sd)
rmse <- sqrt(mean(mod$residuals^2))
...
ggplot(data, aes(x = NDTI, y = depth_sd)) +
  ...
  theme_classic() +
  labs(y = "Depth Stdev") +
  geom_abline(slope = -1.51199, intercept = 0.05364, 
              linetype = 'dashed', color = '#264653')
r <- cor(data$NDTI, data$depth_sd)
rmse <- sqrt(mean(mod$residuals^2))
print(paste0("r = ", r, ", RMSE = ", rmse))
